...
public SwarcoEnumerations(){}
    ...
    public enum LoggingDestinationType {API_CLIENT,OMNIA_CLIENT,OMNIA_HTTPSERVER,CLOUD_HTTPSERVER,OMNIVIEW_CLIENT,NOT_DEFINED}
    ...
    public enum TRPXTaskTypes {MEASUREMENT_DATA_INSERT,CONTROLLER_INTERSECTION_DATA_CHANGE,DETECTOR_DATA_CHANGE,LOAD_CURRENT_CONTROLLER_INTERSECTION_DATA,LOAD_CURRENT_DETECTORS_DATA, CONTROLLER_STATUS_DATA_INSERT,NOT_DEFINED}
