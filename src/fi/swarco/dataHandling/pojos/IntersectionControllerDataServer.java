...
public class IntersectionControllerDataServer {
    ...
    private long omniaPublicationStatus=0;
    private long intersectionId=0;
    private String intesectionDescription=NO_VALUE;
    private long intersectionAreaId=0;
    private long  intersectionMaintenanceAreaId =0;
    private String intersectionExternalCode=NO_VALUE;
    private long  intersectionSubSystemId=0;
    private long  intersectionVisible=0;
    private long  intersectionDeleted=0;
    private String intersectionDataPreviousUpdate="1970-01-01 00:00:00";
    private String  intersectionGuid=NO_VALUE;
    private long  intersectionProgressId=0;
    private long controllerId=0;
    private String controllerDescription=NO_VALUE;
    private long controllerTypeId=0;
    private long controllerRoadsideUnitId=0;
    private String controllerExternalCode=NO_VALUE;
    private long controllerSubSystemId=0;
    private long controllerObjectPriorityId=0;
    private long controllerVisible=0;
    private long controllerDeleted=0;
    ...
    public void MakeEmptyElement() {
        ...
        omniaName=NO_VALUE;
        omniaPublicationStatus =0;
        intersectionId=0;
        intesectionDescription=NO_VALUE;
        intersectionAreaId=0;
        intersectionMaintenanceAreaId =0;
        intersectionExternalCode=NO_VALUE;
        intersectionSubSystemId=0;
        intersectionVisible=0;
        intersectionDeleted=0;
        intersectionDataPreviousUpdate="1970-01-01 00:00:00";
        intersectionGuid=NO_VALUE;
        intersectionProgressId=0;
        controllerId=0;
        controllerDescription=NO_VALUE;
        controllerTypeId=0;
        controllerRoadsideUnitId=0;
        controllerExternalCode=NO_VALUE;
        controllerSubSystemId=0;
        controllerObjectPriorityId=0;
        controllerVisible=0;
        controllerDeleted=0;
