...
public class SelectMeasurementDataShortMySqlWhereLahti {
    private static Logger logger = Logger.getLogger(SelectMeasurementDataShortMySqlWhereLahti.class.getName());
    ...
    private void  buildStatement () {
        ...
        statement =	statement + " from OmniaMeasurementDataShortLahti ";
