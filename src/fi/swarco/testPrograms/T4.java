...
public class T4 {
    ...
    private static Logger logger = Logger.getLogger(T4.class.getName());
    ...
    public static void main(String[] args) throws IOException, InterruptedException{
        ...
        //    SelfRestart jis = new SelfRestart();
            logger.info("KantaYhteys OK! restart");
           // jis.StartMySelf();
            // restart start
